 ...
 * @param {Object} params
 * @param {Array} params.sources - Array of TimeSourceData structures
 * @returns {Promise<void>}
 */
export const setTimeSources = ({ sources }) => {
    return setProperty("TimeSources", cockpit.variant("a(ssb)", sources));
};
 ...
 * @param {Object} params
 * @param {string} params.dateTimeSpec - Date and time (e.g. '2024-06-05T13:23')
 * @returns {Promise<void>}
 */
