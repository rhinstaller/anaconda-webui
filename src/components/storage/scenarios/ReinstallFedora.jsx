...
const useAvailabilityHomeReuse = () => {
    ...
    useEffect(() => {
        ...
        debug(`home reuse: Default scheme is ${defaultScheme}.`);
        if (reusedOS) {
            ...
            if (homeDeviceType !== requiredSchemeTypes[defaultScheme]) {
                availability.available = false;
                availability.hidden = true;
                debug(`home reuse: No reusable existing Linux system found, reused devices must have ${requiredSchemeTypes[defaultScheme]} type`);
            }
        }
        ...
        if (reusedOS) {
            ...
            const unknownMountPoints = getUnknownMountPoints(defaultScheme, reusedOS);
